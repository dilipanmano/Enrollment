...
def enrollment():
    ...
    if courseID:
        if Enrollment.objects(user_id = user_id,courseID= courseID):
            flash(f"You have already enrolled in the course {courseTitle}","danger")
...
#         fdata = courseData
#     else:
#         fdata = courseData[int(idx)]
#     return Response(json.dumps(fdata), mimetype = "application.json")


@app.route("/user")
def user():
    # User(user_id =1,first_name ="Dilipan",last_name ="M",email ="dilipan12m@gmail.com",password="asdfqwer").save()
    # User(user_id =2,first_name ="Bruce",last_name ="Wayne",email ="batman@gmail.com",password="kaboom").save()
